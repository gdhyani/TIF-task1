    ...
    return (
        <section className="flex flex-col sm:flex-row bg-[#F8F8F8] px-[42px] sm:px-[104px] sm:py-[84px] justify-between">
            <div className=" flex justify-center pt-[52px] sm:pt-0 sm:items-center mb-[42px] sm:mb-0">
                <Image
                    className="w-[107px] h-[83px] sm:w-[161px] sm:h-[125px]"
                    src="/truck.svg"
                    width={300}
                    height={300}
                    alt="truck.svg"
            ...
            <div className="mb-[29px] flex flex-col roboto sm:w-[217px] sm:gap-[15px]">
                <h1 className="text-[#0E2368]  text-[15.771px] sm:text-[18.843px] font-semibold leading-[34.804px]">
                    Contact Us
                </h1>
            ...
            <div className="sourceSans flex flex-col sm:gap-[15px]">
                <h1 className="text-[#0E2368] text-[15.771px] sm:text-[18.843px] font-semibold leading-[29.45px]">
                    More
                </h1>
            ...
            <div className="flex flex-col-reverse sm:justify-between sm:flex-col justify-center pb-[34.65px] sm:pb-[0px]">
                <div className="flex flex-col text-center ">
                    <h1 className="hidden sm:block text-[#0E2368] sourceSans text-[15.771px] sm:text-[19px] font-semibold leading-[29.45px]">
                        Social Links
                    </h1>
